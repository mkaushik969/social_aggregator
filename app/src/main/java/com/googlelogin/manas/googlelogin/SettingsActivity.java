    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                Toast.makeText(SettingsActivity.this,"Facebook login successful",Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onCancel() {
                Toast.makeText(SettingsActivity.this,"Facebook login failed",Toast.LENGTH_SHORT).show();
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    startActivity(new Intent(SettingsActivity.this,NewsFeedActivity.class));
                    finish();
                }
                else
                {
                    Toast.makeText(SettingsActivity.this,"Please login with atleast one of the profiles",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    // User is signed in
//                    Toast.makeText(SettingsActivity.this,"already Signed In",Toast.LENGTH_SHORT).show();
                } else {
                    // User is signed out
//                    Toast.makeText(SettingsActivity.this,"already Signed out",Toast.LENGTH_SHORT).show();
                }
                // ...
            }
        };
    ...
    private void logoutGoogle() {
        Auth.GoogleSignInApi.signOut(mGoogleApiClient).setResultCallback(new ResultCallback<Status>() {
            ...
            public void onResult(@NonNull Status status) {
                if(status.isSuccess())
                {
                    Toast.makeText(SettingsActivity.this,"Signed out of Google successfully",Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(SettingsActivity.this,"Google sign out failed",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    {
        LISessionManager.getInstance(getApplicationContext()).init(SettingsActivity.this, buildScope(), new AuthListener() {
            @Override
...
//                            Toast.makeText(SettingsActivity.this, "Google login failed",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
//                            Toast.makeText(SettingsActivity.this, "Google login successful",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
